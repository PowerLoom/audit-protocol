...
//	}
//
//	verifier.redisCache, err = gi.Invoke[*redis.Client]()
//	if err != nil {
//		return nil, err
//	}
//
...
//		dagBlock, err := verifier.ipfsClient.GetDagBlock(cid)
//		if err != nil {
...
//		}
//		payload, err := verifier.ipfsClient.GetPayloadChainHeightRang(dagBlock.Data.PayloadLink.Cid)
//		if err != nil {
...
//	for i := 0; i < 3; i++ {
//		res := verifier.redisCache.HGetAll(context.Background(), key)
//		if res.Err() != nil {
//			if res.Err() == redis.Nil {
//				return nil
//			}
